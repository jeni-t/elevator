function afterShaderTool(){
  let baseDirectory = "https://neural-hive-3d-modules.s3.ap-south-1.amazonaws.com/demo/afterShaderTool/";
  ...
  let clear = BABYLON.GUI.Button.CreateSimpleButton("clear_button","Inspector");
  function manage() {
    //alert('hi am working');
  ...
  let canvas = document.getElementById("afterCanvas");
  ...
  zChar.position = new BABYLON.Vector3(0, 0.05 * size, 0.9 * size);
    ...
    var image = new BABYLON.GUI.Image("rotated", baseDirectory+"textures/51116.png");
    image.top = "-30%";
    image.left = "-47%";
    image.width = "50px";
    image.height = "50px";
  ...
  gizmo.attachedMesh = Tooth_1;*/
    ...
    var images = new BABYLON.GUI.Image("translate", baseDirectory+"textures/478165.png");
    images.top = "-20%";
    images.left = "-47%";
    images.width = "50px";
    images.height = "50px";
