function perspectiveViewTool (maxillary_file, mandibular_file) {
  var cube=null;
  var sphere=null;
  var box;
  ...
  var canvas = document.getElementById("perspectiveView");
  ...
  var delayCreateScene = function () {
    ...
    BABYLON.SceneLoader.ImportMesh("","",mandibular_file,scene,function (meshe){
      sphere=meshe[0];
      sphere.parent = box;
    ...
    BABYLON.SceneLoader.ImportMesh("","",maxillary_file,scene,function (meshe){
      cube=meshe[0];
      cube.parent = box;
      cube.material = matte;
      //camera.setTarget(sphere);
   ...
   cube=null;
        ...
        BABYLON.SceneLoader.ImportMesh("","",mandibular_file,scene, async function (meshe){
          sphere=meshe[0];
          sphere.parent = box;
          sphere.material = matte;
          camera.setTarget(sphere);
   ...
   cube=null;
        ...
        BABYLON.SceneLoader.ImportMesh("","",maxillary_file,scene,async function (meshes){
          cube=meshes[0];
...
*/
   ...
   advancedTexture.addControl(image); 
    ...
    var image = new BABYLON.GUI.Image("Top", assetsDirectory+"Top+1.png");
    image.top = "30%";
    image.left = "45%";
    image.width = "48px";
    image.height = "48px";
